...
BOOT_TASK         = boot_task
BOOT_TASK_SRC     = ../../../software/boot_task/plasma/boot_task.asm
...
$(TASK_OBJ): $(TASK_SRC) 
	...
	@$(LD_MIPS) -Ttext 0 -eentry -Map $*.map -s -N -o $*.elf $(BOOT_TASK).o $*.o
	@$(LD_MIPS) -Ttext 0 -eentry -Map $*_debug.map -o $*_debug.elf $(BOOT_TASK).o $*.o
