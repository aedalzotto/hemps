...
void write_local_msg_to_task(TCB * task_tcb_ptr, int msg_lenght, int * msg_data){
	...
	msg_ptr = (Message*)((task_tcb_ptr->offset) | ((unsigned int)task_tcb_ptr->reg[REG_A1])); //reg[a1] = address message
