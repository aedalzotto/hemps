...
def generate_deloream_env(testcase_path, yaml_r):
    
    debug_path = testcase_path+"/debug"
    ...
    services_cfg(testcase_path, debug_path, yaml_r)
    
    platform_cfg(testcase_path, debug_path, yaml_r)
...
def platform_cfg(testcase_path, debug_path, yaml_r):
    
    mpsoc_x = get_mpsoc_x_dim(yaml_r)
    mpsoc_y = get_mpsoc_y_dim(yaml_r)
    cluster_x = get_cluster_x_dim(yaml_r)
    cluster_y = get_cluster_y_dim(yaml_r)
